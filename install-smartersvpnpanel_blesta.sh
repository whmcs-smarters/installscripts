...
bigecho "IonCube Installation Done!"
sudo service apache2 restart
}
...
cat >> /etc/crontab <<EOF
*/5 * * * * /usr/bin/php -q $DIRPATH/blesta/index.php cron > /dev/null 2>&1
