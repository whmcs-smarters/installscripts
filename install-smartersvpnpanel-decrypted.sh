...
if [ -d "smartersvpnpanel-decrypted" ];then
rm -r smartersvpnpanel-decrypted
echo "Removing existing folder "
bigecho " Cloning ......"
git clone https://whmcs-smarters:1818e49e450cbcd0a5d4c76d338243c45807dcf9@github.com/whmcs-smarters/smartersvpnpanel-decrypted.git
else
bigecho " Cloning ......"
git clone https://whmcs-smarters:1818e49e450cbcd0a5d4c76d338243c45807dcf9@github.com/whmcs-smarters/smartersvpnpanel-decrypted.git
fi
...
rm -r $DIRPATH/*
mv -f smartersvpnpanel-decrypted/* $DIRPATH
else
mv -f smartersvpnpanel-decrypted/* $DIRPATH
fi
...
if [ -f /root/install-smartersvpnpanel-decrypted.sh ];then
rm /root/install-smartersvpnpanel-decrypted.sh
